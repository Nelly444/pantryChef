  ...
  return (
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
      {CARDS.map(({ key, Icon, label, accent }) => (
        <div key={key} className={`rounded-2xl border border-olive/20 border-l-4 ${accent} bg-white p-4 shadow-sm`}>
          <div className="mb-3 inline-flex h-8 w-8 items-center justify-center rounded-lg bg-forest/10 text-forest">
            <Icon size={15} />
          </div>
